        ...
        <div class="signup-main">
            ...
            <div class="signup-content d-flex">
                ...
                <div class="type-input col-lg-12">
                    <select class="col-lg-12 mb-3" name="" id="">
                        <option selected value="">Dispatcher</option>
                        <option value="">Driver</option>
                    </select>
                </div>
                <div class="fullname-input">
                    <label class="mb-3 mt-3" for="">Full Name</label>
                    <input class="col-lg-12 mb-3" type="text">
                </div>
                ...
                <div class="password-input">
                    ...
                    <input class="col-lg-12 mb-3" type="password">
                </div>
