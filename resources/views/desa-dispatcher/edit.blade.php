            ...
            <div class="basic-card mb2">
                <div class="basic-card-head mt3">
                    <div class="row mb2">
                        <div class="col-8">
                            ...
                            <input id="hidden" type="hidden" name="id" value="{{$detailsedit->id}}">
                        </div>
                    </div>
                    <h5>Drivers</h5>
                </div>
                ...
                <div class="row mt1">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="number" name="trailer" id="" placeholder="28" value="{{$detailsedit->trailer}}">

                    </div>
                    <div class="col-lg-4">
                        <label for="">Odometer</label>
                        <input type="text" name="odometer" id="" placeholder="12" value="{{$detailsedit->odometer}}">
            ...
            <div class="basic-card mb2" id="pickup-card">
                ...
                <div class="row mt2">
                    ...
                    <div class="row mt1">
                        ...
                        <div class="row mt3">
                            <div class="col-lg-6">
                                <button id="pickup-btn" type="button"><i class="fas fa-plus-circle"></i>Add Another
                                    Pickup</button>
                            </div>
                        </div>
                        @endif
                ...
                <div id="routing-stop-card" class="row mt1">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="date" name="routeRoutingStopDate[]" id="" value="{{$value->route_stop_date}}">
                ...
                <div class="row mt1" id="delivery-card">
                    ...
                    <div class="row mt3">
                        <div class="col-lg-6">
                            <button id="delivery-btn" type="button"><i class="fas fa-plus-circle"></i>Add Another
                                Delivery</button>
                        </div>
                    </div>
                    @endif
            ...
            <div class="basic-card mb2">
                ...
                <div class="row mt1">
                    ...
                    <div class="col-lg-4 d-flex flex-column">
                        ...
                        <select id="types" name="primaryFeeType">
                            <option value="{{$detailsedit->primary_fee_type}}" disabled selected>
                                {{$detailsedit->primary_fee_type}} </option>
                            <option value="Flat Free">Flat Free</option>
                        </select>
                    </div>
                </div>
                <div class="basic-card-head mt3">
                ...
                <div class="row mt2">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="dollar-input">
                            <label for=""><i class="fas fa-dollar-sign"></i></label>
                            <input type="text" placeholder="0.00" name="detention" value="{{$detailsedit->detention}}">
                        </div>
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="dollar-input">
                            <label for=""><i class="fas fa-dollar-sign"></i></label>
                            <input type="text" placeholder="0.00" name="stopOff" value="{{$detailsedit->stop_off}}">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        ...
                        <div class="dollar-input">
                            <label for=""><i class="fas fa-dollar-sign"></i></label>
                            <input type="text" placeholder="0.00" name="tarpFee" value="{{$detailsedit->tarp_fee}}">
                        </div>
                    </div>
                </div>
                <div class="basic-card-head mt3">
                        ...
                        <div class="add-fuel-sec">
                            ...
                            <div class="added-fuel-expense-card">
                                <div class="row">
                                    ...
                                    <div class="wrapp">
                                        ...
                                        <select class="fuel-dropdown" name="fuelExpenseType" id="added-fuel-expense">
                                            <option value="{{$detailsedit->fuel_expense_type}}" disabled selected>
                                                {{$detailsedit->fuel_expense_type}}
                                            </option>
                                ...
                                <div class="mb2 mt1">
                                    ...
                                    <div class="dollar-input">
                                        <label for=""><i class="fas fa-dollar-sign"></i></label>
                                        <input type="text" placeholder="0.00" value="{{$detailsedit->fuel_expense}}">
                                    </div>
                                </div>
                        ...
                        <div class="add-truck-expense-sec">
                            <div class="added-truck-expense-card">
                                <div class="mb2 mt1">
                                    ...
                                    <div class="dollar-input">
                                        <label for=""><i class="fas fa-dollar-sign"></i></label>
                                        <input type="text" placeholder="0.00" name="truck_expense"
                                            value="{{$detailsedit->truck_expense}}">
                                    </div>
                                </div>
                                <button type="button" id="remove-truck-expense-btn"><i
                                        class="fas fa-minus-circle"></i>Remove Truck Expenses</button>
                            </div>
                        </div>
                        @else
                        <button id="add-truck-expense-btn" type="button"><i class="fas fa-plus-circle"></i>Add Truck
                            Expenses</button>
                        @endif
                    </div>
                </div>
                        ...
                        <div class="add-refer-fuel-card-sec">
                            <div class="added-refer-fuel-expense-card">
                                <div class="mb2 mt1">
                                    ...
                                    <div class="dollar-input">
                                        <label for=""><i class="fas fa-dollar-sign"></i></label>
                                        <input type="text" placeholder="0.00" name="refer_fuel_expense"
                                            value="{{$detailsedit->truck_expense}}">
                                    </div>
                                </div>
                                <button id="remove-refer-fuel-expense-btn" type="button"><i
                                        class="fas fa-minus-circle"></i>Remove Refer Fuel Expenses</button>
                            </div>
                        </div>
                        @else
                        <button id="add-refer-fuel-btn" type="button"><i class="fas fa-plus-circle"></i>Add Refer Fuel
                            Expenses</button>
                        @endif
                    </div>
                </div>
